...
var PostListComponent = /** @class */ (function () {
    function PostListComponent(postsService, authService, store, route) {
        this.postsService = postsService;
        this.authService = authService;
        this.store = store;
        this.route = route;
    ...
    PostListComponent.prototype.ngOnInit = function () {
        ...
        this.postsSub = this.postsService
            ...
            if (_this.route.snapshot.url[0] && _this.route.snapshot.url[0].path === "myposts") {
                _this.posts = _this.posts.filter(function (post) {
                    return post.creatorEmail == _this.currentUser.email;
                });
            }
        });
        this.getState.subscribe(function (state) {
